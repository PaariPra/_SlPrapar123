...
public class FontPickerAdapter extends RecyclerView.Adapter<FontPickerAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder viewHolder, int i) {
        ...
        if (selectedPos == i) {
            viewHolder.name.setBackgroundColor(ContextCompat.getColor(context, R.color.purple_200));
        } else {
                ...
                public void onClick(View v) {
                    ...
                    if (getAdapterPosition() != selectedPos) {
                        if (onFontSelectListner != null) {
                            ...
                            name.setBackgroundColor(ContextCompat.getColor(context, R.color.purple_200));
